...
## Project Structure
    ...
    ├── testapiautoconnect_127090  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_127090`
...
2. Clone this repo and `cd testapiautoconnect_127090`
